...
public class LynxAppConfigGridFormatter extends GridFormatterBase {
    private ObjectFormatter dateFormat;

    public LynxAppConfigGridFormatter(GridFormatUtil gridFormatUtil, ISecurityHelper securityHelper, String appId, ObjectFormatter dateFormat) {
        super(gridFormatUtil, appId, securityHelper);
        this.dateFormat = dateFormat;
    }

    public LynxAppConfigGridFormatter() {
    }
