...
public class LynxAppConfigFiltersBar extends FiltersBar {
    ...
    public void create() {
        ...
        appIdFilter.setFilterFieldName(LynxAppConfigFieldsDef.app_id);
        ...
        propTypeFilter.setFilterFieldName(LynxAppConfigFieldsDef.prop_type);
        ...
        propNameFilter.setFilterFieldName(LynxAppConfigFieldsDef.prop_name);
        ...
        envFilter.setFilterFieldName(LynxAppConfigFieldsDef.env);
